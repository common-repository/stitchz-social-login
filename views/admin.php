...
function stitchz_social_login_config_settings_page() {
	...
	?>
	<div class="wrap">
	  <h2><?php esc_html_e( 'Stitchz Social Login API Settings', 'stitchz_social_login' ); ?></h2>
	   ...
	   ?>
	    ...
	    <table class="form-table">
	      <tr class="form-field form-required">
	        <th scope="row">
	          <label for="stitchz_social_login_settings[domain]"><?php esc_html_e( 'App URL', 'stitchz_social_login' ); ?> <span class="description">(<?php esc_html_e( 'required', 'stitchz_social_login' ); ?>)</span></label>
	        </th>
	        <td>
	          <input type="text" name="stitchz_social_login_settings[domain]" id="stitchz_social_login_settings_domain" size="90" value="<?php echo esc_url($domain) ?>" />
	          <div class="stitchz_social_login_description"><?php esc_html_e( 'The App Url or subdomain of your Stitchz Login application', 'stitchz_social_login' ); ?>
	          </div>
	        </td>
	      </tr>
	      <tr class="form-field form-required">
	        <th scope="row">
	          <label for="stitchz_social_login_settings[apikey]"><?php esc_html_e( 'ApiKey', 'stitchz_social_login' ); ?> <span class="description">(<?php esc_html_e( 'required', 'stitchz_social_login' ); ?>)</span></label>
	        </th>
	        <td>
	          <input type="text" name="stitchz_social_login_settings[apikey]" id="stitchz_social_login_settings_apikey" size="90" value="<?php echo esc_attr($apikey) ?>" placeholder="000000000000" />
	          <div class="stitchz_social_login_description"><?php esc_html_e( 'Your Stitchz Login application apikey', 'stitchz_social_login' ); ?>
	          </div>
	        </td>
	      </tr>
	      <tr class="form-field form-required">
	        <th scope="row">
	          <label for="stitchz_social_login_settings[appsecret]"><?php esc_html_e( 'AppSecret', 'stitchz_social_login' ); ?> <span class="description">(<?php esc_html_e( 'required', 'stitchz_social_login' ); ?>)</span></label>
	        </th>
	        <td>
	          <input type="text" name="stitchz_social_login_settings[appsecret]" id="stitchz_social_login_settings_appsecret" size="90" value="<?php echo esc_attr($appsecret) ?>" placeholder="000000000000" />
	          <div class="stitchz_social_login_description"><?php esc_html_e( 'Your Stitchz Login application secret', 'stitchz_social_login' ); ?>
	          </div>
	        </td>
	      </tr>
	      <tr class="form-field form-required">
	        <th scope="row">
	          <label for="stitchz_social_login_settings[redirecturl]"><?php esc_html_e( 'Return URL', 'stitchz_social_login' ); ?> <span class="description">(<?php esc_html_e( 'required', 'stitchz_social_login' ); ?>)</span></label>
	        </th>
	        <td>
	          <input type="text" name="stitchz_social_login_settings[redirecturl]" id="stitchz_social_login_settings_redirecturl" size="90" value="<?php echo esc_url($redirecturl) ?>" placeholder="&lt;your wordpress url&gt;" />
	      ...
	      <tr class="form-field">
	        <th scope="row">
	          <label for="stitchz_social_login_settings[version]"><?php esc_html_e( 'API Version', 'stitchz_social_login' ); ?></label>
	        </th>
	        <td>
	          <select name="stitchz_social_login_settings[version]" id="stitchz_social_login_settings_version">
	            <option value="1"<?php echo ( $version === '1' ? ' selected="selected"' : '' ); ?>><?php esc_html_e( 'Standard Login', 'stitchz_social_login' ); ?></option>
	            <option value="2"<?php echo ( $version === '2' ? ' selected="selected"' : '' ); ?>><?php esc_html_e( 'OAuth 2 Login', 'stitchz_social_login' ); ?></option>
	          </select>
	          <div class="stitchz_social_login_description"><?php esc_html_e( 'The version of api call to authenticate the user', 'stitchz_social_login' ); ?>
	          </div>
	        </td>
	      </tr>
	    </table>

	    <h2><?php esc_html_e( 'Stitchz Login Provider List', 'stitchz_social_login' ); ?></h2>
	    <div><?php esc_html_e( 'After your configuration settings have been set, click the button below to test your settings and sync your identity providers from your Stitchz Login application here.', 'stitchz_social_login' ); ?></div>
	    <table class="form-table">
	      <tr class="form-field">
	        <td>
	          <input type="button" class="button" value="<?php esc_html_e( 'Sync Providers', 'stitchz_social_login' ); ?>" id="stitchz_social_login_sync_providers" />
	        </td>
	        <td>
	          <input type="button" class="button" value="<?php esc_html_e( 'Clear Providers', 'stitchz_social_login' ); ?>" id="stitchz_social_login_clear_providers" />
              <input type="hidden" name="stitchz_social_login_settings[providers]" id="stitchz_social_login_settings_providers" value="<?php echo esc_attr($providers) ?>" />
              <input type="hidden" name="stitchz_social_login_settings[scope]" id="stitchz_social_login_settings_scope" value="<?php echo esc_attr($scope) ?>" />
            </td>
          </tr>
	      <tr>
	    ...
	    <h2><?php esc_html_e( 'Stitchz Login Addin Settings' , 'stitchz_social_login' ); ?></h2>
	    <div></div>
	    <table class="form-table">
	      <tr class="form-field">
	        <th scope="row">
	          <label for="stitchz_social_login_settings[theme_version]"><?php esc_html_e( 'Theme Version' , 'stitchz_social_login' ); ?></label>
	        </th>
	        <td>
	          <select name="stitchz_social_login_settings[theme_version]" id="stitchz_social_login_settings_theme_version">
	            <option value="<?php echo esc_attr($theme_version) ?>"<?php echo ( $theme_version === 'Basic' ? ' selected="selected"' : '' ); ?>><?php esc_html_e( 'Basic' , 'stitchz_social_login' ); ?></option>
	          </select>
	          <div class="stitchz_social_login_description"><?php esc_html_e( 'The version to display the Social Login icons in', 'stitchz_social_login' ); ?>
	          </div>
	        </td>
	      </tr>
	      <tr class="form-field">
	        <th scope="row">
	          <label for="stitchz_social_login_settings[enable_user_login_screen]"><?php esc_html_e( 'Enable on User_Login Screen', 'stitchz_social_login' ); ?>?</label>
	        </th>
	        <td>
	          ...
	          <div class="stitchz_social_login_description"><?php esc_html_e( 'A boolean value indicating whether or not to show social login icons on the user_login form', 'stitchz_social_login' ); ?>
	          </div>
	        </td>
	      </tr>
          <tr class="form-field">
            <th scope="row">
              <label for="stitchz_social_login_settings[enable_user_registration_screen]"><?php esc_html_e( 'Enable on User Registration Screen', 'stitchz_social_login' ); ?>?</label>
            </th>
            <td>
              ...
              <div class="stitchz_social_login_description"><?php esc_html_e( 'A boolean value indicating whether or not to show social login icons on the user registration form', 'stitchz_social_login' ); ?>
              </div>
            </td>
          </tr>
          <tr class="form-field">
            <th scope="row">
              <label for="stitchz_social_login_settings[enable_comment_screen]"><?php esc_html_e( 'Enable on Comments Screen', 'stitchz_social_login' ); ?>?</label>
            </th>
            <td>
              ...
              <div class="stitchz_social_login_description"><?php esc_html_e( 'A boolean value indicating whether or not to show social login icons on the comments form', 'stitchz_social_login' ); ?>
              </div>
            </td>
          </tr>
	      <tr class="form-field">
	        <th scope="row">
	          <label for="stitchz_social_login_settings[notes]"><?php esc_html_e( 'Social Login Notes', 'stitchz_social_login' ); ?></label>
	        </th>
	        <td>
	          <input type="text" size="255" value="<?php echo esc_html($notes) ?>" name="stitchz_social_login_settings[notes]" />
	          <div class="stitchz_social_login_description"><?php esc_html_e( 'A short description or note displayed under the social login icons (255 characters or less)', 'stitchz_social_login' ); ?>
	          </div>
	        </td>
	      </tr>
	    </table>
	    ...
	    <p class="submit">
	      <input type="submit" value="<?php esc_html_e( 'Save', 'stitchz_social_login' ); ?>" class="button button-primary" />
