...
* Description: Stitchz Social Login adds the option to authenticate users with one or more of the 22+ social identities providers supported by Stitchz with a simple interface that maintains all your social identity provider information safely and securely. Using Stitchz saves you from having to integrate and manage each identity provider individually.
* Version: 1.0.4
...
define( 'STITCHZ_SOCIAL_LOGIN_VERSION', '1.0.4' );
